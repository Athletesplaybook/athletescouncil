module.exports = {
	...
	interpolateEnvVariables: {
 	...
 	removeAPIKeys: {
            command: `sed -i '' 's/'"$TAC_PREVIEW_TOKEN"'/TAC_PREVIEW_TOKEN/g' _config.yml && sed -i '' 's/'"$CONTENTFUL_ACCESS_TOKEN"'/CONTENTFUL_ACCESS_TOKEN/g' _config.yml && sed -i '' 's/'"$TAC_CONTENTFUL_SPACE_ID"'/TAC_CONTENTFUL_SPACE_ID/g' _config.yml`
    },
    commentContentful: {
